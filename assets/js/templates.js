...
function insightMini(i){
  ...
  return `<div class="mini-card is-${i.type}${!vis?' hidden':''}" data-key="insight-${i.id}" onmousedown="startCardDrag(event,'insight','${i.id}')" onclick="if(!justDragged) openPanel('insight','${i.id}')">
...
function gapMini(g){
  ...
  return `<div class="mini-card${!vis?' hidden':''}" data-key="gap-${g.id}" onmousedown="startCardDrag(event,'gap','${g.id}')" onclick="if(!justDragged) openPanel('gap','${g.id}')">
    <div class="mini-card-top">
...
function solutionMini(s){
  ...
  return `<div class="mini-card is-solution${!vis?' hidden':''}${s.isIdea?' is-idea':''}" data-key="sol-${s.ref}" onmousedown="startCardDrag(event,'solution','${s.ref}')" onclick="if(!justDragged) openPanel('solution','${s.ref}')" style="position:relative">
    <div class="mini-card-top">
...
function oppMini(o){
  ...
  return `<div class="mini-card${!vis?' hidden':''}" data-key="opp-${o.id}" onmousedown="startCardDrag(event,'opp','${o.id}')" onclick="if(!justDragged) openPanel('opp','${o.id}')">
    <div class="mini-card-top">
